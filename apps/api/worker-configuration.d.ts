/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings --env stage` (hash: e1ed0567618061702e8799d89179b0cd)
// Runtime types generated with workerd@1.20250913.0 2025-09-17 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		DB_URL: string;
		BETTER_AUTH_SECRET: string;
		BETTER_AUTH_URL: string;
		BETTER_AUTH_ALLOWED_ORIGINS: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DB_URL" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "BETTER_AUTH_ALLOWED_ORIGINS" | "RESEND_API_KEY">> {}
}
